...
<div class="ibox float-e-margins">
    <div class="ibox-title clearfix">
        ...
        <?php echo form_open(site_url('transcript_report'), ' method="GET" class="form-horizontal ng-pristine ng-valid"') ?>
    ...
    <div class="ibox-title clearfix">
        <table cellspacing="0" cellpadding="0" class="table table-bordered"
            ...
            <tr>
                ...
                <th style="width: 100px; text-align: center;">Reg #</th>
            ...
            foreach ($applicant_list as $applicant_key => $applicant_value) {
              //  $mobile1=$this->db->query("select * from students where user_id='".$applicant_value->user_id."'  ")->row()->mobile;
                ...
                <tr>
                    ...
                    <td style="text-align: left;"><?php echo '<a href="javascript:void(0);" style="display: block;" class="popup_student_transcript" ID="' . encode_id($applicant_value->id) . '"
...
<script>
    $(document).ready(function () {
        $("body").on("click",".popup_student_transcript",function () {
            var ID = $(this).attr("ID");
            var title = $(this).attr("title");
            $.confirm({
                title:title,
                content:"URL:<?php echo site_url('popup_student_transcript') ?>/"+ID+'/?status=1',
                confirmButton:'Print',
                ...
                confirm:function () {
                    window.location.href = '<?php echo site_url('print_member_transcript') ?>/'+ID;
                    return false;
                },
                cancel:function () {
                    return true;
