...
<head>
    ...
    <title>SARIS | <?php echo(isset($title) ? $title : ''); error_reporting("E_ERROR");?></title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div style="border-bottom: 1px solid #2f4050; text-align: right; padding: 2px; color: #2f4050; font-weight: bold;">
            ...
            echo 'Year : ' . $active_y->AYear . ' - ' . $active_y->semester;
        ...
        <div class="footer fixed">
            ...
            <div>
                <!-- <strong> &copy; 2012- <?php //echo date('Y'); ?> &nbsp; &nbsp; -->
                <a
...
<script src="<?php echo base_url(); ?>media/js/dynamitable/dynamitable.jquery.min.js"></script>
