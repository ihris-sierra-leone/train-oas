...
<div class="col-lg-6 " >
 ...
 $current_user_id = current_user();
    ...
    <?php }if($password_reset){ ?>
                        &nbsp; | &nbsp; <a href="<?php echo site_url('reset_pass/'.encode_id($value->id)); ?>"><i class="fa fa-"> Reset Pass</i></a> &nbsp;| &nbsp; <a href="<?php echo site_url('del_user/'.$value->id); ?>" style="color: #b64645" onclick="return confirm('Are yoy sure you want to delete this record?');"><i class="fa fa-trash"> Delete</i></a>
    <?php } ?>
</td>
                </tr>
                <?php
