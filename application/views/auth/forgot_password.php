        ...
        <div class="col-md-offset-1 col-md-6">
            ...
            <div class="clear-form">
                ...
                <div class="form-body">
                    ...
                    <p>
                        <label for="password" style="font-size: 14px;">Enter Email</label>
                        <input type="text" name="identity" class="col-md-12" value="" style="margin-top: 0px;" id="identity" placeholder="Email">
                    </p>

                    <p>OR</p>

                    <p>
                        <label for="Email" style="font-size: 14px;">Enter TIOB Reg Number</label>
                        <input type="text" name="identity_number" class="col-md-12" value="" style="margin-top: 0px;" id="identity_number" placeholder="TIOB Number">
                    </p>
