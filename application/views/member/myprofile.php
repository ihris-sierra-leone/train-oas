...
<div class="ibox">
    ...
    <div class="ibox-content">
        ...
        <div class="form-group"><label class="col-lg-3 control-label">Application Type  : <span class="required">*</span></label>
            ...
            <div class="col-lg-7">
                <input type="text"
                       value="<?php echo application_type($APPLICANT->application_type); ?>"
                       class="form-control" disabled="disabled"/>
            </div>
        </div>
        <div class="form-group"><label class="col-lg-3 control-label">Entry Type  :</label>
                ...
                <div class="col-lg-7">
                    <select name="entry_type" class="form-control ">
                        ...
                        <?php
                        $sel =  set_value('entry_type',$APPLICANT->entry_category);
                    ...
                    <?php echo form_error('entry_type'); ?>
                </div>
