...
<div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
      ...
      <?php echo form_open('change_member_programme/'.$member_info->id, ' class="form-horizontal ng-pristine ng-valid"') ?>
        <div class="row">
        <div class="col-lg-6">
          <div class="row">
            ...
            <div class="col-lg-7">
            <input type="text" value="<?php if($member_info->programme_id==0){
              echo "No Progarmme";
              }else{ echo receive_programme_code($member_info->programme_id); } ?>"
