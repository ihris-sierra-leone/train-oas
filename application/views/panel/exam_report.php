...
if (isset($_GET)) {
    ...
    if ($title1 == '') {
        $title1 .= " Exam Report in :<strong> ". date('Y') . '</strong>';
    }
...
<div class="ibox">
    ...
    <div class="ibox-content">
        <?php echo form_open(site_url('exam_report'), ' method="GET" class="form-horizontal ng-pristine ng-valid"') ?>
...
//                    $regno = $this->db->query("select * from students where user_id='$userid'")->row()->registration_number;
                    ...
                    $userid=$value->user_id;
//                    $regno = $this->db->query("select * from students where user_id='$userid'")->row()->registration_number;
                    $rowkey = $this->db->get_where('students', array('user_id'=>$userid))->row();
                    if($rowkey){
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;"><?php  echo $regno; ?></td>
            ...
            <div>
                ...
                <a href="<?php echo site_url('report/export_exam_report/?'.((isset($_GET) && !empty($_GET)) ? http_build_query($_GET):'') ); ?>"
