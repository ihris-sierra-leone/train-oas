<div class="ibox">
    ...
    <div class="ibox-content">
            ...
            <div class="col-md-5">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="no-borders"><?php echo(isset($APPLICANT->entry_category) ? ($APPLICANT->entry_category <> 0 ? entry_type($APPLICANT->entry_category) : '') : ''); ?></td>
                    </tr>
                </table>
        ...
        <?php if (isset($next_kin) && count($next_kin) > 0) { ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div style="font-weight: bold; color: blue; border-bottom: 1px solid blue; font-size: 15px;">Next of
                        Kin
                        1
                    </div>
                    <table class="table">
...
//                    $total_charge += $value->charges;
                        ...
                        <tr>
                            ...
                            <?php //echo $value->reference ?><!--</td>-->
                            <!--                            <td style="text-align: center;">-->
                            <?php //echo $value->msisdn ?><!--</td>-->
                    ...
                    foreach ($education_bg as $rowkey => $rowvalue) {
                        ...
                        <div class="applicant_education_bg" style="margin-bottom: 50px;">
                            ...
                            <table class="mytable2_educatiobbg">
                                ...
                                <?php } ?>
                                <tr>
                                    <th> <?php echo($rowvalue->certificate < 3 ? 'Division' : ($rowvalue->certificate > 6 ? 'G.P.A/Degree Class' : 'G.P.A')) ?>
                                        :
                                    </th>
...
//                    echo '<h4>NO DATA FOUND IN THIS SECTION</h4>';
                ...
                if ($student_info) {
                    ...
                    if (count($results) > 0) {
                        ...
                        <div style="font-size: 16px; margin-bottom: 10px; border-bottom: 1px solid blue; width: 70%; color: blue; font-weight: bold;">
    ...
    <tr>
        ...
        <th  style="width:20%;">When (Month/Year)</th>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div style="font-weight: bold; color: blue; border-bottom: 1px solid blue; font-size: 15px;">Referee
                        1
                    </div>
                    <table class="table">
                        <tr>
...
<?php if (isset($mycoice)) { ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    if (isset($mycoice)) { ?>
                        <table class="table">
                            <tr>
                                <th class="no-borders" style="width: 20%;">Programme Choice :</th>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                '>
                <div class="form-group" id="department"><label class="col-lg-3 control-label">Status : <span
