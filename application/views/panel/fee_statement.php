...
if (isset($_GET)) {
    ...
    if ($title1 == '') {
        $title1 .= " Fee Statement Report in <strong> " . date('Y'). '</strong>';
    }
...
<div class="ibox">
    ...
    <div class="ibox-content">
        <?php echo form_open(site_url('statement'), ' method="GET" class="form-horizontal ng-pristine ng-valid"') ?>
        <div class="form-group no-padding">
            ...
            <div class="col-md-2">
            <select class="form-control" name="year" value="<?php echo(isset($_GET['year']) ? $_GET['year'] : '') ?>">
        ...
        <div class="table-responsive">
            ...
            <thead>
                <tr>
                    ...
                    <th style="width: 100px; text-align: center;">Amount Paid</th>
                </tr>
                </thead>
                <tbody>
                <?php
                ...
                foreach ($statement_fee_list as $key => $value) {
...
//                    var_dump($rowkey);exit;
            ...
            <a href="<?php echo site_url('report/export_fee_statement/?'.((isset($_GET) && !empty($_GET)) ? http_build_query($_GET):'') ); ?>"
