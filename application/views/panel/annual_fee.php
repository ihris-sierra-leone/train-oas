...
if (isset($_GET)) {
    ...
    if ($title1 =='') {
        $title1 .= " Annual subscription fee report in :<strong> " . date('Y') . '</strong>';
...
<div class="ibox">
    <div class="ibox-title">
        <h5>Annual SubscriptionFee</h5>
    </div>
    <div class="ibox-content">
        <?php echo form_open(site_url('annualSubFee'), ' method="GET" class="form-horizontal ng-pristine ng-valid"') ?>
        ...
        <div class="table-responsive">
            ...
            <a href="<?php echo site_url('report/export_annual_payment/?'.((isset($_GET) && !empty($_GET)) ? http_build_query($_GET):'') ); ?>"
