...
if (isset($_GET)) {
    ...
    if ($title1 == '') {
        $title1 .= " Application Fee in  :<strong> " .date('Y') . '</strong>';
    }
...
<div class="ibox">
    <div class="ibox-title">
        <h5>Application and Registration Fee</h5>
    </div>
    <div class="ibox-content">
        ...
        <div class="table-responsive">
            ...
            <div>
                ...
                <a href="<?php echo site_url('report/export_application_payment/?'.((isset($_GET) && !empty($_GET)) ? http_build_query($_GET):'') ); ?>"
