        ...
        <div class="col-lg-8">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group resources" style=" display: none;"><label class="col-lg-3 control-label">Corperate: <span
                                    class="required ">*</span> </label>
                    ...
                    <?php echo form_error('cooperate'); ?>
                    </div>
                    </div>

                    <div class="form-group" ><label class="col-lg-3 control-label">Do you have TIOB REGNO number? : <span
                                    class="required ">*</span> </label>
                        <div class="col-lg-7">
                            <select class="form-control" value="<?php echo set_value('tiob_number_status'); ?>" name="tiob_number_status" id="tiob_number_status" ">
                            <option value="">[ Select  ]</option>
                            <option value="1">Yes</option>
                            <option value="0">No</option>
                            <!-- <?php
                            ...
                            <?php echo form_error('tiob_number_status'); ?>
                        </div>
                    </div>

                    <div class="form-group tiob_number" style=" display: none;"><label class="col-lg-3 control-label">Enter TIOB number ? : <span
                                    class="required ">*</span> </label>
                        <div class="col-lg-7">
                            <input type="text"  name="tiob_number"  value="<?php echo set_value('tiob_number'); ?>"  class="form-control">
                            <?php echo form_error('tiob_number'); ?>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#tiob_number_status").change(function () {
            var status = $(this).val();
            if (status == 1) {
                $('.tiob_number').show();
            }
            else $('.tiob_number').hide();
        });
