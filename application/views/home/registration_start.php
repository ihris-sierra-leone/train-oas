                    ...
                    <div class="form-group"><label class="col-lg-6 control-label">Application Type  : <span class="required">*</span></label>
                        ...
                        <div class="col-lg-6">
                            <select class="form-control" id="type">
                                ...
                                foreach (application_start() as $key=>$value){
...
<?php } ?>
                ...
                <?php }else{
                    echo show_alert("The System is under maintenance, try again later",'success');

//                    echo "<div  align='enter' class='head_title'> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
//&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  class=\"text-danger\" href='https://tiob.or.tz/?page_id=8724'>Download Application Form  here !!</a> </div> ";
//                    echo "<meta http-equiv ='refresh' content ='4;
//								url =https://tiob.or.tz/?page_id=8724'>";
