<div class="ibox">
    ...
    <div class="ibox-content">
        ...
        <div class="form-group"><label class="col-lg-3 control-label">Mobile Number1 : <span
            ...
            <div class="col-lg-8">
                <input type="text" placeholder="Eg. 255xxxxxxxxx" value="<?php echo (isset($sponsor_info) ? $sponsor_info->mobile1:set_value('mobile1')); ?>" class="form-control" name="mobile1" onKeyPress="return numbersonly(event,this.value)" maxlength="12">
        ...
        <div class="form-group"><label class="col-lg-3 control-label">Mobile Number2 :  </label>
            ...
            <div class="col-lg-8">
                <input type="text" placeholder="Eg. 255xxxxxxxxx" value="<?php echo (isset($sponsor_info) ? $sponsor_info->mobile2:set_value('mobile2')); ?>" class="form-control" name="mobile2" onKeyPress="return numbersonly(event,this.value)" maxlength="12">
        ...
        <div class="form-group"><label class="col-lg-3 control-label">Mobile Number1 :<span
            ...
            <div class="col-lg-8">
                <input type="text" placeholder="Eg. 255xxxxxxxxx" value="<?php echo (isset($employer_info) ? $employer_info->mobile1:set_value('mobile21')); ?>" class="form-control" name="mobile21" onKeyPress="return numbersonly(event,this.value)" maxlength="12">
        ...
        <div class="form-group"><label class="col-lg-3 control-label">Mobile Number2 :  </label>
            ...
            <div class="col-lg-8">
                <input type="text" placeholder="Eg. 255xxxxxxxxx" value="<?php echo (isset($employer_info) ? $employer_info->mobile2:set_value('mobile22')); ?>" class="form-control" name="mobile22" onKeyPress="return numbersonly(event,this.value)" maxlength="12">
