...
if(isset($_GET) && isset($_GET['cat']) && isset($_GET['action']) && $_GET['cat'] == 1) {
    ...
    <div class="form-group">
        <label class="col-lg-4 control-label">Institute : <span class="required">*</span></label>

        <div class="col-lg-6">
            <input type="text" placeholder="Name of Institute" value="<?php echo set_value('name',(isset($experience_info) ? $experience_info->name:'')); ?>" class="form-control" name="name">
