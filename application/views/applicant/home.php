...
<div class="row gray-bg">
    <div class="container">
        <div class="col-lg-3 no-padding no-margins">
            <div style="font-weight: bold; font-size: 15px; margin-bottom: 10px;">Online support : <?php echo ONLINE_SUPPORT; ?> </div>
                ...
                <div class="ibox-content no-padding">
                    <ul class="folder-list m-b-md" style="padding: 0">
                        ...
                        <?php if($activate_account){ ?>
                            ...
                            <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( $photo ? site_url('applicant_education/'.($education ? encode_id($education):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Education Background <span class="label label-warning pull-right"><i class="fa <?php echo  ($education ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                            ...
                            <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( $attachment ? site_url('applicant_choose_programme/'.($programme ? encode_id($programme):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Choose Programme <span class="label label-warning pull-right"><i class="fa <?php echo  ($programme ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                            <?php
                            if($APPLICANT->application_type == 3){
                                ?>
        ...
        <div class="col-lg-9" style="padding-right: 0px;">
            <div class="progress progress-striped active">
                <div style="width: <?php echo number_format($count_progress/9*100); ?>%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" role="progressbar" class="progress-bar progress-bar-danger">
