...
//            $payment_transactio = $this->db->where(array('applicant_id'=>$APPLICANT->id,'academic_year'=>$year))->get("annual_fees")->result();
//
//            $total = 0;
//
...
<!--                <td style="text-align: right;">--><?php //echo number_format(($total+$total_amount+$total_charge),2) ?><!--</td>-->
            ...
            <div class="col-md-12">
                ...
                <div class="form-group" style="margin-top: 20px;">
                    ...
                    <div class="col-lg-offset-1" style="font-weight: bold; color: red; font-size: 14px;">
                        NOTE : Once you submit this application you will not be able to edit or change any information.
                        Please confirm all information is correct before click button below
                    </div>
                </div>
