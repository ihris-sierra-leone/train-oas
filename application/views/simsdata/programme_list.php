                    ...
                    <table cellspacing="0" cellpadding="0" class="table table-bordered table-responsive"
                        ...
                        foreach ($programme_list as $key1 => $value1) {
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle; text-align: center"><a href="<?php echo site_url('add_programme/'.$value1->id) ?>"><i class="fa fa-pencil"></i> Edit</a> |
                                    <a style="color: #b64645" href="<?php echo site_url('delete_programme/'.$value1->id) ?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-trash"></i> Delete</a>
                                </td>
