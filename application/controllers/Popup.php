...
class Popup extends CI_Controller
{
    ...
    function get_programmes()
    {
        ...
        if (isset($_GET['department']) && isset($_GET['application_type'])) {
            ...
            $programme_list = $this->db->query("SELECT * FROM programme WHERE Departmentid='$department' AND `type`='$application_type'")->result();
    ...
    function get_programme_selection()
    {
        $programmes = '';
        if (isset($_POST['department_id']) && isset($_POST['application_type'])) {
            ...
            foreach ($programme_list as $ky => $rowkey) {
                $programmes .= '<option value="' . $rowkey->Code . '">' . $rowkey->Name . '</option>';
            }
            echo $programmes;
        }
    }
